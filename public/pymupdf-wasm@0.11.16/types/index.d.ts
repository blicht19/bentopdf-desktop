...
export type TextExtractionFormat =
  | 'text'
  | 'blocks'
  | 'words'
  | 'dict'
...
export declare class PyMuPDFPage {
  ...
  insertImage(
    ...
    options?: { overlay?: boolean; keepProportion?: boolean }
  ): void;
...
export declare class PyMuPDFDocument {
  ...
  addOCG(
    name: string,
    options?: { config?: number; on?: boolean; intent?: string; usage?: string }
  ): number;
  addOCGWithParent(
    name: string,
    parentXref: number,
...
export declare class PyMuPDF {
  ...
  pdfToLlmChunks(pdf: Blob | File): Promise<
    Array<{
      text: string;
  ...
  pdfToLlamaIndex(pdf: Blob | File): Promise<
    Array<{
      text: string;
